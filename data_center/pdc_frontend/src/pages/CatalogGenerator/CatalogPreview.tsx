...
const ATTR_LABELS_AR: Record<string, string> = {
    ...
    vein_pattern: 'نمط العروق',
    import_grade: 'درجة الاستيراد',
    /* أثاث ومفروشات */
    furniture_type: 'نوع الأثاث',
    seat_capacity: 'سعة الجلوس',
    assembly_required: 'يتطلب تجميع',
    weight_capacity: 'الحمل الأقصى',
    /* دهانات */
    ...
    coats: 'عدد الطبقات',
    coats_required: 'عدد الطبقات المطلوبة',
    dilution: 'نسبة التخفيف',
    washability: 'قابلية الغسيل',
    voc_content: 'محتوى VOC',
    voc: 'محتوى VOC',
    /* إضاءة وكهرباء */
    ...
    power: 'القدرة',
    lumens: 'الإضاءة (لومن)',
    ip_rating: 'درجة الحماية IP',
    dimmable: 'قابل للتعتيم',
    lifespan: 'العمر الافتراضي',
    frequency: 'التردد',
    energy_rating: 'تصنيف الطاقة',
    /* سباكة وصرف */
    pipe_diameter: 'قطر الأنبوب',
    pressure_rating: 'ضغط العمل',
    flow_rate: 'معدل التدفق',
    water_saving: 'موفر للماء',
